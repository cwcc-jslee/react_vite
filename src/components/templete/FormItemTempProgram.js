...
const FormItemTempProgram = ({
  ...
  const customerOnSelect = (data, option) => {
    ...
    selectedCustomer.current = option.id;
    console.log('selectedCustomer', selectedCustomer);
  };

  const handleOnSubmitCheck = (value) => {
    console.log('selectedCustomer', selectedCustomer);
    if (drawer.action === 'proposal-add') {
      if (selectedCustomer.current) {
        const newValue = { ...value, customer: selectedCustomer.current };
        handleOnSubmit({
          value: newValue,
          isChecked: isChecked,
  ...
  const MakeFormItems = (list) => {
    ...
    const FormItems = () => {
      ...
      } else if (form === 'CUSTOMERAUTOCOMPLETE' && action === 'proposal-add') {
        return (
          <>
            <Form.Item
              label={list.label}
...
export default FormItemTempProgram;
