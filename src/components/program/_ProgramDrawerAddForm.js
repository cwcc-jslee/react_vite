...
const ProgramDrawerAddForm = ({
  ...
  const onChange = (values, option) => {
    ...
    // 매출이익 계산 - sfa_profit_margin
    // if (option['data-grp'] === 'sfa_profit_margin') {
    //   console.log('88880@@@@@', calSalesProfit);
    //   // setSalesValue(0);
    //   calSalesProfit.current.sfa_profit_margin = option.children;
    // }
  };
...
export default ProgramDrawerAddForm;
