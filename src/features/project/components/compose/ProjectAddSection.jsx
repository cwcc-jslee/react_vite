...
import { FiPlus } from 'react-icons/fi'; // 추가 아이콘
    ...
    <div className="flex-shrink-0 w-72 h-full flex flex-col">
      ...
      <div className="flex flex-col h-full border-0 rounded-md bg-gray-50 shadow-sm mx-2">
        ...
        <div className="p-3 border-b">
          ...
          <button className="w-full h-10 flex items-center justify-center text-indigo-600 border-2 border-indigo-600 rounded-sm">
        ...
        <div className="flex-grow overflow-y-auto p-3">
          {tasks.map((task, index) => (
            <TaskCard
              ...
              {...task}
              onClick={() =>
                onTaskClick && onTaskClick(columnIndex, index, task)
              }
            />
          ))}
        </div>
    ...
    <div className="w-full h-full">
      ...
      >
        ...
        <div className="flex-shrink-0 w-72 h-full flex items-start p-2">
          <button className="w-full h-10 bg-indigo-600 text-white border-2 border-indigo-600 rounded-sm flex items-center justify-center">
            <FiPlus className="mr-2" size={18} />
            <span>버킷 추가</span>
          </button>
        </div>
