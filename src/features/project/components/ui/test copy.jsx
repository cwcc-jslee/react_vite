<div className="text-zinc-800 text-sm pb-12 px-12 relative">
  <div>
    ...
    <div className="flex-wrap flex">
      ...
      <div className="basis-[23.75rem] flex-grow">
        <div className="font-semibold">
          <div>
            종속 대상
            <div className="text-zinc-600 pt-1.5">
              이 작업은 다른 작업에 종속되지 않습니다.
            </div>
          </div>
          <button className="cursor-pointer px-4 text-center inline-block w-28 h-8 border-2 border-gray-200 border-solid rounded-sm">
            <span className="items-center justify-center flex">
        ...
        <div className="font-semibold">
          <div>첨부 파일</div>
          <button className="cursor-pointer px-4 text-center inline-block w-32 h-9 border-2 border-gray-200 border-solid rounded-sm">
            <span className="items-center justify-center flex">
              <span className="flex-grow">
                <span>첨부 파일 추가</span>
              </span>
        ...
        <div className="font-semibold py-4">대화</div>
        <div className="bg-stone-50 pb-7 px-6 pt-3">
          <div className="justify-center flex">
            <img
              className="w-24 h-24"
              src="https://res.cdn.office.net/msplanner/ui/static/releases/uno_prod/all/assets/addprojecttoteams.6bf3b93fd2e128fa7449.svg"
            />
          </div>
          <div className="text-center">
            Teams 채널에 이 계획을 추가한 다음 Teams에서 이 작업에 대한 대화를
            시작하세요.
            <a
              className="text-indigo-700 pl-1.5"
              href="https://aka.ms/projectteamsapp"
            >
              자세한 정보
            </a>
          </div>
          <div className="justify-center text-center flex text-neutral-800 font-semibold">
            <button className="bg-white cursor-pointer px-4 w-40 h-8 border-2 border-neutral-300 border-solid rounded-sm">
              <span className="items-center justify-center flex">
                <span className="flex-grow">
                  <span>채널에 이 플랜 추가</span>
                </span>
              </span>
            </button>
          </div>
        </div>
        <div className="font-semibold py-4">목표에 연결</div>
        <button className="cursor-pointer px-4 text-center inline-block w-20 h-8 border-2 border-gray-200 border-solid rounded-sm font-semibold">
          <span className="items-center justify-center flex">
            <span className="flex-grow">
              <span>연결</span>
            </span>
